...
echo " <iframe class=\"subframe\" id=\"myIframe\" src=\"../../../Songs/A_hi/x_horiz.html\"></iframe>" >> 0_FrameX.html
echo "" >> 0_FrameX.html
...
echo "        <option value=\"../../../Songs/A_hi/x_horiz.html\">0_hello</option> " >> 0_FrameX.html
case $LESSONDIR in
    *"LI1_Mam"*)
        echo "        <option value=\"../../../Songs/A_hi/L1/x_horiz.html\">3_WarmUp</option> " >> 0_FrameX.html
    ;;
    *"LI2_Choi"*)
        echo "        <option value=\"../../../Songs/A_hi/L2/x_horiz.html\">3_WarmUp</option> " >> 0_FrameX.html
    ;;
    *"LI3_La"*)
        echo "        <option value=\"../../../Songs/A_hi/L3/x_horiz.html\">3_WarmUp</option> " >> 0_FrameX.html
esac
...
echo "" >> 0_FrameX.html
echo "        <option value=\"../../../Songs/Z_bye/x_horiz.html\">27_Bye</option>" >> 0_FrameX.html
echo "   </select>" >> 0_FrameX.html
echo "</body>" >> 0_FrameX.html
